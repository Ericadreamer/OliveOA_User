...
public class DimissionActivity extends AppCompatActivity {
    ...
    private EditText eNumber,eReason,eMatter;  //离职员工编号，离职原因，交代事项
    private TextView tDate,tDuty,taddPerson;   //离职日期，所属部门职务，添加审批人
    ...
    private void initView() {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(DimissionActivity.this, MyApplicationActivity.class);
        ...
        LinesEditView linesEditView = new LinesEditView(DimissionActivity.this);
