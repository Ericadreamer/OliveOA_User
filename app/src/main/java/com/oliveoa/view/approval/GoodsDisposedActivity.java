...
public class GoodsDisposedActivity extends AppCompatActivity {
    //申请人，选择物品，取用时间，归还时间，审批意见
    private TextView tApplicant,tGoodsName,tstartTime,treturnTime,tadvise;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_goods_disposed);
