...
public class ReadWaitActivity extends Fragment {
            ...
            switch (msg.what){
                case 1:
                    ...
                    if(list!=null&list.size()!=0){
                        ...
                        mContentRv.setAdapter(new ReadWaitActivity.ContentAdapter(list));
                    }else{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        rootview = inflater.inflate(R.layout.activity_read_wait, container, false);
    ...
    private class ContentAdapter extends RecyclerView.Adapter<ReadWaitActivity.ContentAdapter.ContentHolder> {
        ...
        @Override
        public ReadWaitActivity.ContentAdapter.ContentHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new ContentHolder(LayoutInflater.from(getActivity()).inflate(R.layout.item_document, parent, false));

        }

        @Override
        public void onBindViewHolder(final ReadWaitActivity.ContentAdapter.ContentHolder holder, final int position) {
    ...
    public void initData() {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                DocumentService service = new DocumentService();
                //Todo Service.Method
                StatusAndMsgAndDataHttpResponseObject<ArrayList<OfficialDocument>> statusAndMsgAndDataHttpResponseObject = service.getdocumentNeedRead(s);
                //ToCheck JsonBean.getStatus()
