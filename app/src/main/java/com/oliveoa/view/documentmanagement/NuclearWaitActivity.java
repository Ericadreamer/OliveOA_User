...
public class NuclearWaitActivity extends Fragment {
            ...
            switch (msg.what){
                case 1:
                    ...
                    if(list!=null&list.size()!=0){
                        ...
                        mContentRv.setAdapter(new NuclearWaitActivity.ContentAdapter(list));
                    }else{
    ...
    private class ContentAdapter extends RecyclerView.Adapter<NuclearWaitActivity.ContentAdapter.ContentHolder> {
        private List<OfficialDocument> documents;
        public ContentAdapter(List<OfficialDocument> documents) {
            this.documents = documents;
        }
        @Override
        public NuclearWaitActivity.ContentAdapter.ContentHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            if (getItemCount() == 0) {
        ...
        @Override
        public void onBindViewHolder(final NuclearWaitActivity.ContentAdapter.ContentHolder holder, final int position) {
        ...
        private void info(int position) {
            ...
            if (statusAndDataHttpResponseObject.getStatus() == 0) {
                ...
                Intent intent = new Intent(getActivity(), NuclearAdviseActivity.class);
    ...
    public void initData() {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                DocumentService service = new DocumentService();
                //Todo Service.Method
                StatusAndMsgAndDataHttpResponseObject<ArrayList<OfficialDocument>> statusAndMsgAndDataHttpResponseObject = service.getdocumentNeedNuclear(s);
                //ToCheck JsonBean.getStatus()
