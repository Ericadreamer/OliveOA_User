...
public class IssueActivity extends AppCompatActivity {
    ...
    //Tab 文字
    private final int[] TAB_TITLES = new int[]{R.string.issue_wait, R.string.issue_done};
    //Fragment 数组
    private final Fragment[] TAB_FRAGMENTS = new Fragment[]{new IssueWaitActivity(), new IssueDoneActivity()};
    //Tab 数目
    ...
    public void initView() {
        ...
        back.setOnClickListener(new View.OnClickListener() {  //点击返回键，返回主页
            ...
            public void onClick(View view) {
                Intent intent = new Intent(IssueActivity.this, DocumentManagementActivity.class);
     ...
     */
    private class IssuePagerAdapter extends FragmentPagerAdapter {
