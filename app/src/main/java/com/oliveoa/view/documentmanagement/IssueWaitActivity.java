...
public class IssueWaitActivity extends Fragment {
            ...
            switch (msg.what){
                case 1:
                    ...
                    if(list!=null&list.size()!=0){
                        ...
                        mContentRv.setAdapter(new IssueWaitActivity.ContentAdapter(list));
                    }else{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        rootview = inflater.inflate(R.layout.activity_issue_wait, container, false);
    ...
    private class ContentAdapter extends RecyclerView.Adapter<IssueWaitActivity.ContentAdapter.ContentHolder> {
        ...
        @Override
        public IssueWaitActivity.ContentAdapter.ContentHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            if (getItemCount() == 0) {
        ...
        @Override
        public void onBindViewHolder(final IssueWaitActivity.ContentAdapter.ContentHolder holder, final int position) {
        ...
        private void info(int position) {
            ...
            if (statusAndDataHttpResponseObject.getStatus() == 0) {
                ...
                Intent intent = new Intent(getActivity(),IssueDocumentActivity.class);
    ...
    public void initData() {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                DocumentService service = new DocumentService();
                //Todo Service.Method
                StatusAndMsgAndDataHttpResponseObject<ArrayList<OfficialDocument>>  statusAndMsgAndDataHttpResponseObject = service.getdocumentNeedIssue(s);
                //ToCheck JsonBean.getStatus()
