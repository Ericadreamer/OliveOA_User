...
public class NoticeListActivity extends Fragment {
            ...
            switch (msg.what){
                case 1:
                    ...
                    if(notice!=null&notice.size()!=0){
                        ...
                        mContentRv.setAdapter(new ContentAdapter(notice));
                    }else{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)  {
        rootview = inflater.inflate(R.layout.activity_notice_list, container, false);
